...
pathtovcf_files='/spaces/gapw/diversity/mamana/VCF_FILTERED/BAYLOR'
                  /spaces/gapw/diversity/mamana/VCF_FILTERED/BAYLOR
...
HDVpipeline_26Jan.sh: line 10: =/spaces/gapw/diversity/mamana/VCF_FILTERED/BAYLOR: No such file or directory
HDVpipeline_26Jan.sh: line 12: syntax error near unexpected token `('
HDVpipeline_26Jan.sh: line 12: `declare -a pop =("BOT" "BRN" "CAM" "FNB" "WGR" "MAL" "ZAM")'