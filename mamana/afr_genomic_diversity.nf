...
annotate_vcf_merge.into {annotate_vcf_merge; annotate_vcf_merge_sub}
annotate_vcf_merge_sub.subscribe{
...
annotate_dbsnp_merge.into {annotate_dbsnp_merge; annotate_dbsnp_merge_sub}
annotate_dbsnp_merge_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
vcf_anc_merge.into {vcf_anc_merge; vcf_anc_merge_sub}
vcf_anc_merge_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
gwascatalog_b37tob38.into {gwascatalog_b37tob38; gwascatalog_b37tob38_sub}
gwascatalog_b37tob38_sub.subscribe{
    println "Finished ${it}"
}
...
annotate_gwascat_merge.into {annotate_gwascat_merge; annotate_gwascat_merge_sub}
annotate_gwascat_merge_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
annotate_clinvar_merge.into {annotate_clinvar_merge; annotate_clinvar_merge_sub}
annotate_clinvar_merge_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
annotate_cosmic_merge.into {annotate_cosmic_merge; annotate_cosmic_merge_sub}
annotate_cosmic_merge_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
mafs_annot_merge.into {mafs_annot_merge; mafs_annot_merge_sub}
mafs_annot_merge_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
annotate_cosmic_merge_list = annotate_cosmic_merge_1.toSortedList().val
annotate_cosmic_merge_2 = [:]
annotate_cosmic_merge_list.each{ chrm, vcf_file ->
    annotate_cosmic_merge_2[chrm] = [chrm, file(vcf_file)]
    annot = []
    datasets = []
    ...
    annotate_cosmic_merge_2[chrm] << annot.join(';')
    annotate_cosmic_merge_2[chrm] << datasets.toSorted().join('-')
}
annotate_cosmic_merge_2_cha = Channel.from(annotate_cosmic_merge_2.values())
...
annotate_mafs_merge.into {annotate_mafs_merge; annotate_mafs_merge_sub}
annotate_mafs_merge_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
norelated_merge.into {norelated_merge; norelated_merge_sub}
norelated_merge_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
process vcf_sites_only_merge {
    ...
    memory { 10.GB * task.attempt }
    time { 5.hour * task.attempt }
    publishDir "${params.work_dir}/VCF_FILTERED/SITE_ONLY/MERGED", overwrite: true, mode:'copy'
    input:
...
// TODO: Coverage filtering NOT on MERGE dataset because missing DP INFO
//'''
//Step 1.9: Filter VCF by coverage depth using bcftools
//'''
//norelated_merge.into{ norelated_merge; norelated_merge_1}
//process filter_vcf_by_depth_merge {
...
//    publishDir "${params.work_dir}/VCF_FILTERED/MERGED", overwrite: true, mode:'symlink'
//    input:
//        set val(chrm), file(vcf_file), file(vcf_file_tbi) from norelated_merge_1
//    output:
//        set val(chrm), file(vcf_out), file("${vcf_out}.tbi") into vcf_6depth_merge
//    script:
//        vcf_out = "${file(vcf_file.baseName).baseName}_dp6.vcf.gz"
//        """
//        ${params.venv}/bin/bcftools view -i 'DP>6' ${vcf_file} | bgzip -c > ${vcf_out}
//        ${params.venv}/bin/bcftools index --tbi -f ${vcf_out}
//        """
//}
//vcf_6depth_merge.into {vcf_6depth_merge; vcf_6depth_merge_sub}
//vcf_6depth_merge_sub.subscribe{
//    println "Finished ${it.join(', ')}"
//}
...
annotate_dbsnp_baylor.into {annotate_dbsnp_baylor; annotate_dbsnp_baylor_sub}
annotate_dbsnp_baylor_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
annotate_gwascat_baylor.into {annotate_gwascat_baylor; annotate_gwascat_baylor_sub}
annotate_gwascat_baylor_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
annotate_clinvar_baylor.into {annotate_clinvar_baylor; annotate_clinvar_baylor_sub}
annotate_clinvar_baylor_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
annotate_cosmic_baylor.into {annotate_cosmic_baylor; annotate_cosmic_baylor_sub}
annotate_cosmic_baylor_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
annotate_cosmic_baylor_list = annotate_cosmic_baylor_1.toSortedList().val
annotate_cosmic_baylor_2 = [:]
annotate_cosmic_baylor_list.each{ chrm, vcf_file ->
...
annotate_cosmic_baylor_2_cha = Channel.from(annotate_cosmic_baylor_2.values())
...
annotate_mafs_baylor.into {annotate_mafs_baylor; annotate_mafs_baylor_sub}
annotate_mafs_baylor_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
norelated_baylor.into {norelated_baylor; norelated_baylor_sub}
norelated_baylor_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
vcf_6depth_baylor.into {vcf_6depth_baylor; vcf_6depth_baylor_sub}
vcf_6depth_baylor_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
vcf_anc_only.into {vcf_anc_only; vcf_anc_only_sub}
vcf_anc_only_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
biallOnly_baylor.into {biallOnly_baylor; biallOnly_baylor_sub}
biallOnly_baylor_sub.subscribe{
    println "Finished ${it.join(', ')}"
}
...
//        """
//}
//split_POP_samples_all.into {split_POP_samples_all; split_POP_samples_all_sub}
//split_POP_samples_all_sub.subscribe{
//    println "|-- Finished ${it.join(', ')}"
//}
//
//'''
...
//        """
//}
//split_vcf_per_pop.into {split_vcf_per_pop; split_vcf_per_pop_sub}
//split_vcf_per_pop_sub.subscribe{
...
//        """
//}
//split_vcf_per_pop_reduced.into {split_vcf_per_pop_reduced; split_vcf_per_pop_reduced_sub}
//split_vcf_per_pop_reduced_sub.subscribe{
//    println "|-- Finished ${it[-1][-1]}"
//}
//
//'''
...
//        """
//}
//merge_vcf_pop.into{ merge_vcf_pop; merge_vcf_pop_sub}
//merge_vcf_pop_sub.subscribe {
//    println "|-- Finished ${it.join(', ')}"
//}
//
//
...
//        """
//}
//merge_vcf_pop_reduced.into{ merge_vcf_pop_reduced; merge_vcf_pop_reduced_sub}
//merge_vcf_pop_reduced_sub.subscribe {
//    println "|-- Finished ${it.join(', ')}"
//}
//
//'''
...
//        """
//}
//daf_by_pop.into{ daf_by_pop; daf_by_pop_sub}
//daf_by_pop_sub.subscribe {
//    println "|-- Finished ${it.join(', ')}"
//}
//
//'''
...
//        """
//}
//singl_by_pop.into{ singl_by_pop; singl_by_pop_sub}
//singl_by_pop_sub.subscribe {
//    println "|-- Finished ${it.join(', ')}"
//}
...
//}
//plot_pgxAverageSingletonsPerPopulation.into{ plot_pgxAverageSingletonsPerPopulation; plot_pgxAverageSingletonsPerPopulation_sub}
//plot_pgxAverageSingletonsPerPopulation_sub.subscribe {
//     println "|-- Finished for ${it.join(', ')}"
//}
...
//        """
//}
//annotate_dbnsfp_baylor.into {annotate_dbnsfp_baylor; annotate_dbnsfp_baylor_1}
//annotate_dbnsfp_baylor_1.subscribe{
//    println "Finished ${it.join(', ')}"
//}
...
//        """
//}
//download_gnomad_genomes.into {download_gnomad_genomes; download_gnomad_genomes_1}
//download_gnomad_genomes_1.subscribe{
//    println "Finished ${it.join(', ')}"
//}
