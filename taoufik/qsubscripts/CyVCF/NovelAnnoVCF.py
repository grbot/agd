...
if os.path.splitext(base)[1]=='.gz':
	...
	outFName = '%s%s/%s_Novel.csv'%(outputfolder,os.path.splitext(os.path.splitext(base)[0])[0].split('_')[0],os.path.splitext(os.path.splitext(base)[0])[0])
else:
	...
	outFName = '%s/%s%s_Novel.csv'%(outputfolder,os.path.splitext(os.path.splitext(base)[0])[0].split('_')[0],os.path.splitext(base)[0])
